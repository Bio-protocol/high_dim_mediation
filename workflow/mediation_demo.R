...
pathname = paste("largedata/mediation_outputs/res_fixed_bic_trait_", ".csv", sep = trait )
...
pathname = paste("largedata/mediation_outputs/res_fixed_eq_trait_", ".csv", sep = trait )
fwrite(as.list(res.eq.pcut), pathname, sep=",", row.names=FALSE, quote=FALSE)



directsnps.fixed = reportDirectSNPs(mod=mod.fixed, tst=tests.fixed)
pathname = paste("largedata/mediation_outputs/dsnps_fixed_bic_trait_", ".csv", sep = trait)
...
pathname = paste("largedata/mediation_outputs/mediators_fixed_bic_trait_", ".csv", sep = trait)
...
pathname = paste("largedata/mediation_outputs/isnps_fixed_bic_trait_", ".csv", sep = trait)
...
pathname = paste("largedata/mediation_outputs/dsnps_fixed_eq_trait_", ".csv", sep = trait)
if(nrow(directsnps.eq)>=1){fwrite(directsnps.eq, pathname , sep=",", row.names=FALSE, quote=FALSE)}


mediators.eq = reportMediator(mod=mod.eq, tst=tests.eq)
pathname = paste("largedata/mediation_outputs/mediators_fixed_eq_trait_", ".csv", sep = trait)
if(nrow(mediators.eq) >= 1){fwrite(mediators.eq, pathname, sep=",", row.names=FALSE, quote=FALSE)}

indirect_snps.eq <- reportINDirectSNPs(mod=mod.eq, e2m=e2m.eq, tst=tests.eq, pval.cut=pval.cut, Z=Z, colnames_X=colnames(X))
pathname = paste("largedata/mediation_outputs/isnps_fixed_eq_trait_", ".csv", sep = trait)
if(nrow(indirect_snps.eq)>=1){fwrite(indirect_snps.eq, pathname, sep=",", row.names=FALSE, quote=FALSE)}


####################################### run the estimation step for MedMix
...
pathname = paste("largedata/mediation_outputs/res_mix_linear_trait_",".csv",sep = trait)
...
pathname = paste("largedata/mediation_outputs/res_mix_shrink_trait_",".csv",sep = trait)
...
pathname = paste("largedata/mediation_outputs/mediators_mix_linear_trait_",".csv",sep = trait)
...
pathname = paste("largedata/mediation_outputs/mediators_mix_shrink_trait_",".csv",sep = trait)
