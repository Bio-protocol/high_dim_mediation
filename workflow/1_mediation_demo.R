...
pathname = paste("output/res_fixed_eq_trait_", ".csv", sep = trait )
...
pathname = paste("output/dsnps_fixed_eq_trait_", ".csv", sep = trait)
...
pathname = paste("output/mediators_fixed_eq_trait_", ".csv", sep = trait)
...
pathname = paste("output/isnps_fixed_eq_trait_", ".csv", sep = trait)
...
pathname = paste("output/res_mix_linear_trait_",".csv",sep = trait)
...
pathname = paste("output/res_mix_shrink_trait_",".csv",sep = trait)
...
pathname = paste("output/mediators_mix_linear_trait_",".csv",sep = trait)
...
pathname = paste("output/mediators_mix_shrink_trait_",".csv",sep = trait)
